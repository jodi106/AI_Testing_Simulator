...
/// MainController manages the user interface and the interactions with the scenario editor.
/// </summary>
public class CopyOfMainController : MonoBehaviour
{
    public VisualTreeAsset eventEntryTemplate;
    //Spawned Cars
    public GameObject vehiclePrefab;
    ...
    /// <summary>
    /// Initializes the CopyOfMainController and sets up event listeners.
    /// </summary
    void Start()
    {
        Info = new ScenarioInfo();
    ...
    /// <summary>
    /// Updates the CopyOfMainController and handles user input.
    /// </summary>
    public void Update()
    {
        if (Input.GetMouseButtonDown(1) || Input.GetKeyDown(KeyCode.Escape))
    ...
    private void DeleteSelectedEntity()
    {
        ...
        SetSelectedEntity(null);
        // Pointer exit event is not called
        CopyOfMainController.HideToolTip();
    }

...
{
    public const float VEHICLE_SELECTED = -0.05f;
    public const float VEHICLE_DESELECTED = -0.04f;
    public const float PATH_SELECTED = -0.03f;
    ...
    public const float WAYPOINT_DESELECTED = -0.025f;
    public const float WAYPOINT_SELECTED = -0.035f;
